...
\subsection{Descubrir datos}
    \subsubsection{Reporte de descripción de datos}
        ...
        \resizebox{\columnwidth}{!}{\begin{tabular}{||c | c | c||}
            ...
            \hline
            channel\_title & alfanumerica & Es el nombre del canal del usuario que publico el video \\
            \hline
            category\_id & numeric & it is the number that represent a category name  \\
            \hline
            publish\_time & timestamp & momento exacto de la publicacion del video \\
            \hline
            tags & alfanumerico & Etiquetas que se pueden agregar al video \\
            \hline
            views & numeric & Cantidad de vistas del video en el momento de la fecha de trending\_date \\
            \hline
            ...
            \hline
            comment\_count & numeric & Cantidad de comentarios del video \\
            \hline
            thumbnail\_link & url & enlace a \\
            \hline
    ...
    \subsubsection{Reporte de exploración de datos}
            ...
            \begin{figure}[ht]
                \begin{adjustbox}{addcode={
                    \begin{minipage}{\width}}{
                        \caption{Cantidad de videos segun la categoria}
                    \end{minipage}},rotate=360,center}
                    \includegraphics[scale=.5]{Analisis-de-categorias.png}
                \end{adjustbox}
            \end{figure}
        \FloatBarrier
        ...
        \paragraph{Analisis de vistas en funcion de likes}
            \begin{figure}[ht]
                \begin{adjustbox}{addcode={
                    \begin{minipage}{\width}}{
                        \caption{Cantidad de vistas segun la cantidad de likes}
                    \end{minipage}},rotate=360, center}
                    \includegraphics[scale=.6]{Analisis_de_vistas_en_funcion_de_likes.png}
                \end{adjustbox}
            \end{figure}
        \FloatBarrier
        ...
        \paragraph{Analisis de vistas en funcion de la diferencia de dias entre la fecha de tendencia y la de publicacion}
            ...
            \begin{figure}[ht]
                \begin{adjustbox}{addcode={
                    ...
                    \end{minipage}},rotate=360,center}
                    \includegraphics[scale=.6]{Analisis_de_vistas_en_funcion_de_la_diferencia_de_dias_entre_la_fecha_de_tendencia_y_la_de_publicacion.png}
                \end{adjustbox}
            \end{figure}
        \FloatBarrier
        ...
        \paragraph{Analisis de vistas en funcion de la diferencia de likes y dislikes}
            ...
            \begin{figure}[ht]
                \begin{adjustbox}{addcode={
                    ...
                    \end{minipage}},rotate=360,center}
                    \includegraphics[scale=.6]{Analisis_de_vistas_en_funcion_de_la_diferencia_de_likes_y_dilikes.png}
                \end{adjustbox}
            \end{figure}
        \FloatBarrier
        ...
        \paragraph{Analisis del progreso de views del video con mayor views del set de datos.}
            ...
            \begin{figure}[ht]
                \begin{adjustbox}{addcode={
                    ...
                    \end{minipage}},rotate=360,center}
                    \includegraphics[scale=.6]{Analisis_del_progreso_de_views_del_video_con_mayor_views_del_set_de_datos.png}
                \end{adjustbox}
            \end{figure}
        \FloatBarrier
        ...
        \paragraph{Analisis del progreso de views de los videos con mayor, mediano y menor vistas del set de datos.}
            ...
            \begin{figure}[ht]
                \begin{adjustbox}{addcode={
                    ...
                    \end{minipage}},rotate=360,center}
                    \includegraphics[scale=.6]{Analisis_del_progreso_de_views_de_los_videos_con_mayor_mediano_y_menor_vistas_del_set_de_datos.png}
                \end{adjustbox}
            \end{figure}
        \FloatBarrier
        ...
        \paragraph{Analisis de la cantidad de views segun el largo del titulo del video.}
            ...
            \begin{figure}[ht]
                \begin{adjustbox}{addcode={
                    ...
                    \end{minipage}},rotate=360,center}
                    \includegraphics[scale=.6]{Analisis_de_la_cantidad_de_views_segun_el_largo_del_titulo_del_video.png}
                \end{adjustbox}
            \end{figure}
        \FloatBarrier
        ...
        \paragraph{Analisis la cantidad de videos borrados por categoria.}
            ...
            \begin{figure}[ht]
                \begin{adjustbox}{addcode={
                    ...
                    \end{minipage}},rotate=360,center}
                    \includegraphics[scale=.6]{Analisis_la_cantidad_de_videos_borrados_por_categoria.png}
                \end{adjustbox}
            \end{figure}
        \FloatBarrier
        ...
        \paragraph{Analisis de la cantidad de vistas de videos segun tenga o no descripcion.}
            ...
            \begin{figure}[ht]
                \begin{adjustbox}{addcode={
                    ...
                    \end{minipage}},rotate=360,center}
                    \includegraphics[scale=.6]{Analisis_de_la_cantidad_de_vistas_de_videos_segun_tenga_o_no_descripcion.png}
                \end{adjustbox}
            \end{figure}
        \FloatBarrier
