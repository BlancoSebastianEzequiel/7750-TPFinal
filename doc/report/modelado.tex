...
\subsection{Construir el modelo}
    ...
    \subsubsection{Modelos}
        ...
        \newpage
            ...
            Aqui tenemos la salida de la aplicacion del modelo con las reglas de desicion:

                \begin{figure}[ht]
                    \begin{adjustbox}{addcode={
                        \begin{minipage}{\width}}{
                            \caption{%
                                Arbol de desicion con reglas
                                }
                        \end{minipage}},rotate=360,center}
                        \includegraphics[scale=.4]{../doc/report/pics/arbol_con_reglas.jpg}
                    \end{adjustbox}
                \end{figure}
            \FloatBarrier
            \newpage
